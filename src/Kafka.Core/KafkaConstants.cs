...
namespace CluedIn.Crawling.Kafka.Core
{
    public class KafkaConstants
    {
        ...
        public const string CrawlerDescription = "Kafka is a ... to be completed ...";
        ...
        // src\Kafka.Provider\Resources\cluedin.png
        ...
        public const string CodeOrigin = "Kafka";
        public const string ProviderRootCodeValue = "Kafka";
        public const string CrawlerName = "KafkaCrawler";
        public const string CrawlerComponentName = "KafkaCrawler";
        public static readonly Guid ProviderId = Guid.Parse("54b81503-f2e2-4adf-9cfa-3ab5e4e93671");

...
namespace CluedIn.Crawling.Kafka.Infrastructure.Installers
{
    public class InstallComponents : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            container
                ...
                .Register(Component.For<IKafkaClientFactory>().AsFactory())
                .Register(Component.For<KafkaClient>().LifestyleTransient());
